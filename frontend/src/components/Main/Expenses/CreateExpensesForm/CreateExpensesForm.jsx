...
import createExpenseAPI from "../../../../data/APIs/Expenses/createExpenseAPI";
...
const CreateExpensesForm = (props) => {  
    ...
    const createHandler =  async (e) => {
        ...
        if (error.length === 0) {
            try {
                const data = await createExpenseAPI(props.emailLogin, name, date, Number(category), amount);
    ...
    return (
        <FormPopup label = "Add Expense" submit = {createHandler} close = {props.closeForm}>            
            <Input
                id = "create-name"
                label = "Name"
                type = "text"
