...
import getIncomesSummaryAPI from "../../../../data/APIs/Incomes/getIncomesSummaryAPI";

import PieChart from "../../../../template/PieChart";
import LineChart from "../../../../template/LineChart";

const IncomesSummary = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const data = await getIncomesSummaryAPI(props.emailLogin);
    ...
    return (
        <Wrapper opacity = {props.opacity}>
            <h1 className="text-2xl font-bold text-center"> Incomes Summary </h1>
            {
                isLoading ? <h1> Loading...</h1> :
                isEmpty ? <h1> You don't have any Incomes. </h1> : 
                <section className="flex flex-col md:flex-row justify-content items-scratch mt-4">
                    <section className="bg-slate-200 w-2/3 md:w-1/3 mx-auto md:mx-2 p-4 rounded-md dropshadow-md">
                        <h1 className="text-center font-bold"> Total Incomes Based on Category </h1>
                    ...
                    <section className="bg-slate-200 w-full mt-2 md:mt-0 md:w-2/3 mx-1 md:mx-2 p-4 rounded-md dropshadow-md">
                        <h1 className="text-center font-bold"> Total Incomes Based on Time Frame </h1>  
